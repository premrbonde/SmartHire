    ...
    const fetchApplications = async () => {
      try {
        ...
        const endpoint = user && user.role === "Employer" 
          ? "http://https://smarthire-1-g9mm.onrender.com/api/v1/application/employer/getall"
          : "http://https://smarthire-1-g9mm.onrender.com/api/v1/application/jobseeker/getall";
  ...
  const deleteApplication = async (id) => {
    try {
      const res = await axios.delete(
        `http://https://smarthire-1-g9mm.onrender.com/api/v1/application/delete/${id}`,
